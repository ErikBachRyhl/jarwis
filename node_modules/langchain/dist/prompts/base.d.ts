 ...
 */
export declare abstract class BasePromptTemplate<FormattedOutput extends BasePromptValue = BasePromptValue> extends Runnable<InputValues, FormattedOutput> implements BasePromptTemplateInput {
    ...
    invoke(input: InputValues, options?: BaseCallbackConfig): Promise<FormattedOutput>;
    /**
